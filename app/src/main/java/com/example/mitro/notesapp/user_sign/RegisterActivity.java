package com.example.mitro.notesapp.user_sign;
...
import com.example.mitro.notesapp.MainActivity;
import com.example.mitro.notesapp.R;
...
public class RegisterActivity extends AppCompatActivity {
    ...
    private void registerUser(final String name, String email, String password){
        ...
        progressDialog.setMessage("Обробка запиту, зачекайте...");
                                    ...
                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            ...
                                            if (task.isSuccessful()){
                                                ...
                                                finish();
                                                Toast.makeText(RegisterActivity.this, "Користувача створено!", Toast.LENGTH_SHORT).show();
